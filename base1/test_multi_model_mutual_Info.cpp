...
//多模态互信息配准(梯度下降/正则化梯度下降)
//demo: https://examples.itk.org/src/registration/common/performmultimodalityregistrationwithmutualinformation/documentation#perform-multi-modality-registration-with-viola-wells-mutual-information
//概念：https://blog.csdn.net/qq_31347869/article/details/119394395
//
int
test_multi_model_mutual_Info(int argc, char * argv[])
{
  if (argc < 4)
  {
