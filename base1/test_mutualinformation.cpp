...
//基于互信息 配准
//demo: https://examples.itk.org/src/registration/common/mutualinformation/documentation
...
test_mutualinformation()
{
  ...
  ImageType::Pointer fixedImage = itk::ReadImage<ImageType>(path_fix.data());
  ImageType::Pointer movingImage = itk::ReadImage<ImageType>(path_moving.data());
